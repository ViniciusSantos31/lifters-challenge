...
export const Product: React.FC = () => {
  return (
    <div className="flex-column d-flex h-100">
      <Header />
      <div className="container h-100 d-flex align-items-start justify-content-center mt-4 align-items-md-center">
        <div id="grid-structure">
          <div className="row">
            <div className="col-12 col-md-6">
              <div className="grid">
                <div className="row row-gap-4">
                  <img className="col-6 col-md-6" src="https://via.placeholder.com/200" />
                  <img className="col-6 col-md-6" src="https://via.placeholder.com/200" />
                  <img className="col-6 col-md-6" src="https://via.placeholder.com/200" />
                  <img className="col-6 col-md-6" src="https://via.placeholder.com/200" />
                </div>
              ...
              <div className="d-flex flex-column justify-content-between gap-4">
                <div>
                  ...
                  <div className="gap-4 my-4">
                    ...
                    <div>
                      <h5 className="fs-5 fs-6 my-4">Colors</h5>
                ...
                <div
                  className="w-100 d-flex flex-row gap-2 mb-4 mb-md-0">
